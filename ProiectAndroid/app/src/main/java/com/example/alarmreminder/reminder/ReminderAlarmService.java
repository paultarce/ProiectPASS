...
public class ReminderAlarmService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        NotificationChannel channel = new NotificationChannel(channelId, getString(R.string.reminder_title), NotificationManager.IMPORTANCE_DEFAULT);
        channel.setDescription("Alarma activa");
